...
xcopy /Y /I /Q %EmguCV_Bin_Folder%\x64\release\*.* %TargetBinaryFolder%x64
...
xcopy /Y /I /Q %EmguCV_Bin_Folder%\Emgu.CV.UI.* %SolutionFolder%\lib\emgucv
xcopy /Y /I /Q %EmguCV_Bin_Folder%\Emgu.CV.World.* %SolutionFolder%\lib\emgucv
